                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" id="ProductImage" runat="server" alt="Product Image"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <div class="text-primary mr-2" id="ProductRating" runat="server"></div>
                        <small class="pt-1" id="ReviewCount" runat="server"></small>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4" id="ProductPrice" runat="server"></h3>
